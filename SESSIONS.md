...
**Mini-récap** :
- ✅ Fait : analyse doc + plan de travail ; S2.13 livrée (`8b35dec` — le moteur propose, le PO décide, A8 intact) ; S2.14 livrée (`f35b538` — medium à l'essai, réversible) ; TNR 220 verts ; PR #30 draft
- ⏳ Référent : revue/merge PR #30 ; protection de branche ; compose S1.2 ; Helm lab ; prérequis §7 ; arbitrage PG 16 vs 18.3
- ⏳ Backlog : plans s2.13 + s2.14 à jouer sur pod ; adhérence format de large (seulement si l'essai medium déçoit) ; relance-idempotence scan (s1.7 étape 4)
